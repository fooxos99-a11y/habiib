              ...
              {programs.map((program) => (
                <div
                  ...
                  className={`rounded-xl p-6 transition-all duration-300 relative ${
                    program.is_active
                      ? "bg-white border-2 border-[#3453a7] shadow-md hover:shadow-xl"
                  ...
                  {program.is_active && (
                    <div className="absolute top-4 left-4">
                      <button
                        ...
                        className="flex items-center gap-2 bg-[#3453a7] text-white px-4 py-2 rounded-lg hover:bg-[#4f73d1] transition-colors shadow-lg"
                      >
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <div
                        className={`rounded-lg px-6 py-3 text-center min-w-[140px] ${
                          program.is_active
                            ? "bg-[#3453a7]/10 border border-[#3453a7]"
