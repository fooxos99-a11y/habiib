...
import { Plus, Trash2, ArrowRight, Users, BookOpen, Eye, UserX, Info, Edit2 } from "lucide-react"
          ...
          {selectedStudent && (
            <>
              ...
              <div className="flex justify-end pt-2">
                <Button onClick={() => setIsStudentInfoDialogOpen(false)} className="border border-[#3453a7]/50 bg-[#3453a7]/10 hover:bg-[#3453a7]/20 text-[#4f73d1] hover:text-[#3453a7]">
                  إغلاق
                </Button>
              </div>
            </>
